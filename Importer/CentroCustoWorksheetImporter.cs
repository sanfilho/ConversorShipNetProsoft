...
namespace Importer
{
    public class CentroCustoWorksheetImporter : WorksheetImporter
    {
        public CentroCustoWorksheetImporter(string filePath, int currentWorksheet): base(filePath, currentWorksheet) {
            MaxErrors = 50;
        }
